 ...
 * main.cpp
 * 03/07/2017
 * Description of Problem - Redesign merge sort to sort a list of elements instead of
                            vectors. Create a functional, m_sort, inplaceMerge, and
                            copy function to work with lists.
 * Sketch of Solution - Changed the expected variable types from vectors to list,
                        and added different functionality to the iterators in order
                        to make them work with list.
 * O(nlog(n))
 ********************************************************************************/
