...
int main() {
	...
	cout << "First Set before sorting" << endl;
	printArray(data1, 100);
	cout << endl;

	cout << "Second Set before sorting" << endl;
	printArray(data2, 100);
	cout << endl;

	cout << "Third Set before sorting" << endl;
	printArray(data3, 100);
	cout << endl;

	cout << "Fourth Set before sorting" << endl;
	printArray(data4, 100);
	cout << endl;

	cout << "Fifth Set before sorting" << endl;
	...
	cout << "First Set after sorting" << endl;
	printArray(data1, 100);
	cout << endl;

	cout << "Second Set after sorting" << endl;
	printArray(data2, 100);
	cout << endl;

	cout << "Third Set after sorting" << endl;
	printArray(data3, 100);
	cout << endl;

	cout << "Fourth Set after sorting" << endl;
	printArray(data4, 100);
	cout << endl;

	cout << "Fifth Set after sorting" << endl;
	printArray(data5, 100);
	cout << endl;
